 ...
 *
 */
public class wqtgfroms  extends ActionForm{
	private int fid;						//id
	...
	private String smallnum;				//最低数量
	private String bignum;					//最大数量
	...
	private String spimg2;					//商品图片2
	private String spimg3;					//商品图片3
	private String orderform; 				//订单详情
	
	
	
	public wqtgfroms(int fid, String city, String category, String title,

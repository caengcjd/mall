...
<html>
	<head>
		<jsp:useBean id="fk" class="dao.dingdan.DdDaoImp"></jsp:useBean>
								...
								<div class="box-content">
									...
									<div class="sect">
										<table id="orders-list" cellspacing="0" cellpadding="0"
											...
											<c:forEach items="${fk.alldd}" var="l">
												<c:choose>
													<c:when test="${l.status == '已付款'}">
														<tr class="alt" id="order-list-id-1">
															...
															<td>
																<span class="money">¥</span>${l.dmoney*(n+5)}
															</td>
														</tr>
													</c:when>
													<c:otherwise>

...
<html>
	<head>
	<jsp:useBean id="numb" class="dao.users.UsersDaoImp"></jsp:useBean>
	<jsp:useBean id="day" class="dao.zhanghu.ZhanghuDaoImp"></jsp:useBean>
							...
							<div class="box clear">
								...
								<div class="box-content">
									<div class="head">
										<h2>
											首页
											<span style="display: none"> (ZuituGO_V1.6)</span>
										</h2>
									</div>
									<div class="sect">

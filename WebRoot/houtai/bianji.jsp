		...
		<div id="doc">
			...
			<div id="hdw">
				<div id="hd">
					<div id="logo">
						<a href="#" class="link"
							target="_blank"><src="../images/logo0000.gif" /></a>
					</div>
					<div class="guides">
						<div class="city">
							<h2>
				...
				<div id="bd" class="cf">
					<div id="leader">
						<div class="dashboard" id="dashboard">
							<ul>
								<li>
									<a href="../dangqian.do">当前团购</a><span></span>
								</li>
								<li>
									<a href="../okTuangou.do">成功团购</a><span></span>
								</li>
								<li>
									<a href="../failTuangou.do">失败团购</a><span></span>
								</li>
								<li class="current">
				...
				<div id="ft">
					...
					<div class="copyright">
						...
						<p>
							...
							by
							<a href="#" target="_blank">tuan.now6.cn</a>
						</p>

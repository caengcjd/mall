...
<html>
	<head>
		<jsp:useBean id="ques" class="dao.question.QuestionDaoImp" />
								...
								<div class="box-content">
									...
									<div class="sect">
										<table id="orders-list" cellspacing="0" cellpadding="0"
											...
											<c:forEach items="${ques.allQ}" var="que">
												<tr class="alt" id="team-list-id-2">
													<td>
														<a class="deal-title"
															href="http://192.168.2.49/mt/team.php?id=1">${que.dealid}</a>
													</td>
													<td nowrap>
														${que.user }
													</td>
													...
													<td class="op" nowrap>
														<a
															href="../dafu.do?mid=${que.mid}">答复</a>｜
														<a href="../deldayi.do?mid=${que.mid}" class="remove-record">删除</a>
													</td>
												</tr>
											</c:forEach>
											<tr>

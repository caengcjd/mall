...
<html>
	<head>
		...
		<title>美团 - 管理后台</title>
		<jsp:useBean id="wfk" class="dao.dingdan.DdDaoImp"></jsp:useBean>
				...
				<div id="bd" class="cf">
					<div id="coupons">
						<div class="dashboard" id="dashboard">
							<ul>
								<li>
									<a href="danqiandingdan.jsp">当期订单</a><span></span>
								</li>
								<li>
									<a href="fukuanok.jsp">付款订单</a><span></span>
								</li>
								<li class="current">
									<a href="">未付订单</a><span></span>
								</li>
							</ul>
						</div>
								...
								<div class="box-content">
									...
									<div class="sect">
										<table id="orders-list" cellspacing="0" cellpadding="0"
											...
											<c:forEach items="${wfk.alldd}" var="l">
												<c:choose>
													<c:when test="${l.status == '未付款'}">
														<tr class="alt" id="order-list-id-1">
															...
															<td>${l.xddtime}</td>
															<td class="op">
																<a href="../wfkdel.do?did=${l.did}"
																	class="remove-record">删除</a>
															</td>
														</tr>
													</c:when>
													<c:otherwise>

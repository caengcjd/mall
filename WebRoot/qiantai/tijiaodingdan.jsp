...
>&raquo;
			...
			<div id="bdw" class="bdw">
				<div id="bd" class="cf">
					<div id="content">
						<form
							action="../tjdingdan.do?did=${tgform.fid}&dname=${username}&dtitle=${tgform.title}&dmoney=${tgform.tgprice}&dyue=${qian*1}"
							method="get" class="validator">
										...
										<table class="order-table" width="469" height="248">
											...
											<tr>
												...
												<td class="deal-buy-price">
													<span class="money">¥</span><span id="deal-buy-price">${tgform.tgprice}</span>
												</td>
												<td class="deal-buy-equal">
													=
												</td>
												<td class="deal-buy-total">
													<span class="money">¥</span><span id="deal-buy-total">${tgform.tgprice}</span>
												</td>
											</tr>
											...
											<tr class="order-total">
												...
												<td class="deal-buy-total">
													<span class="money">¥</span><strong id="deal-buy-total-t">${tgform.tgprice}</strong>
												</td>
											</tr>
										</table>

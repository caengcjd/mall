							...
							<div id="deal-buy" class="box">
								...
								<div class="box-content">
									<div class="head">
										<h2>
											应付总额：
											<strong class="total-money">${tgform.tgprice}</strong> 元
										</h2>
									</div>
									<div class="sect">
										<div style="text-align: left;">
											<form action="../fukuan.do?username=${username}&money=${tgform.tgprice}" id="order-pay-credit-form" method="post" sid="10">
												<input type="hidden" name="money" value=${username}/>
												<input type="submit" class="formbutton gotopay"
													value="使用账户余额支付" />
											</form>
											<div class="back-to-check">
												<a href="http://192.168.2.197/mt/order/check.php?id=10">&raquo;
													返回选择其他支付方式</a>
											</div>
										</div>
									</div>

...
<html>
	<head> 
		...
		<meta http-equiv=content-type content="text/html; charset=UTF-8" />
			<title>my 讨论区 | 美团 - 精品团购每一天 |长沙购物|长沙团购|长沙打折</title>
...
>&raquo;
					...
					<ul id="myaccount-menu">
						<li>
							<a href="all.jsp">我的订单</a>
						</li>
						<li>
							<a href="http://192.168.2.49/mt/coupon/index.php">我的优惠券</a>
						</li>
						<li>
							<a href="http://192.168.2.49/mt/account/settings.php">帐户设置</a>
						</li>
					</ul>
				</div>
			</div>
											...
											<tr>
												...
												<td width="660">
													...
													<div class="author">
														...
														<span style="float: right;">就在刚才&nbsp;<a
															href="http://192.168.2.49/mt/ajax/topic.php?action=topicremove&id=3"
															class="ajaxlink" ask="确定删除本话题吗？">－删除</a> </span><b>${tform.tuser}</b>
														<div class="clear"></div>
													</div>

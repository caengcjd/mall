										...
										<table id="orders-list" cellspacing="0" cellpadding="0"
											...
											<c:forEach items="${glist}" var="g">
												<tr class="alt">
													<td style="text-align: left;">
														<a class="deal-title"
															href="http://localhost/mtw/forum/topic.php?id=3" style="">${g.stopic}</a>
													</td>
											...
											<tr>
												<td colspan="5" align="right">
													<a
														href="<%=request.getContextPath()%>/gonggong.do?num=${currpage-1}"

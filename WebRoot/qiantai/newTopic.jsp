...
<html>
	<head>
		...
		<link href="http://192.168.2.80/mt/feed.php?ename=jinan"
	...
	<body class="newbie">
		...
		<div id="doc">
			...
			<div id="hdw">
				<div id="hd">
					<div id="logo">
						<a href="http://192.168.2.80/mt/index.php" class="link"><img
					...
					<div id="header-subscribe-body" class="subscribe">
						<form action="http://192.168.2.80/mt/subscribe.php" method="post"
					...
					<ul class="nav cf">
						...
						<li>
							<a href="http://192.168.2.80/mt/help/tour.php">玩转美团</a>
						</li>
						<li>
					...
					<ul id="myaccount-menu">
						<li>
							<a href="http://192.168.2.80/mt/order/index.php">我的订单</a>
						</li>
						<li>
							<a href="http://192.168.2.80/mt/coupon/index.php">我的优惠券</a>
						</li>
						<li>
							<a href="http://192.168.2.80/mt/account/settings.php">帐户设置</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div id="bd" class="cf">
					<div id="forum">
						<div class="dashboard" id="dashboard">
							<ul>
								<li>
									<a href="all.jsp">所有</a><span></span>
								</li>
								<li>
									<a href="jinan.jsp">长沙讨论区</a><span></span>
								</li>
								<li>
									<a href="gonggong.jsp">公共讨论区</a><span></span>
								</li>
							</ul>
						</div>
									...
									<div class="sect">
										<form id="forum-new-form" method="post" class="validator"
											...
											<div class="field">
												...
												<select name='saddress' style="margin-top: 3px;">
													<option value="b">
														本地讨论区
													</option>
													<option value="j">
											...
											<div class="field">
												...
												<input type="text" size="10" name="stopic"
													id="team-create-style" class="f-input" value=""
											...
											<div class="field">
												...
												<textarea style="width: 480px; height: 240px;" name="sinfo"
													id="forum-new-content" class="f-textarea"
													datatype="require" require="true"></textarea>
											</div>
											<div class="act">
												<input type="submit" value="成立" name="commit"
							...
							<div class="deal-subscribe">
								...
								<div class="body" id="deal-subscribe-body">
									<form id="deal-subscribe-form" method="post"
										action="http://192.168.2.80/mt/subscribe.php">
										<table class="address">
											<tr>
												<td>
			...
			<div id="ftw">
				<div id="ft">
					<p class="contact">
						<a href="http://192.168.2.80/mt/feedback/suggest.php">意见反馈</a>
					</p>
					<ul class="cf">
						<li class="col">
							<h3>
							...
							<ul class="sub-list">
								...
								<li>
									<a href="http://192.168.2.80/mt/help/faqs.php">常见问题</a>
								</li>
								<li>
									<a href="http://192.168.2.80/mt/help/zuitu.php">什么是美团</a>
								</li>
								<li>
									<a href="http://192.168.2.80/mt/help/api.php">开发API</a>
								</li>
							</ul>
						</li>
						<li class="col">
							...
							<ul class="sub-list">
								<li>
									<a href="http://192.168.2.80/mt/subscribe.php?ename=jinan">邮件订阅</a>
								</li>
								<li>
									<a href="http://192.168.2.80/mt/feed.php?ename=jinan">RSS订阅</a>
								</li>
							</ul>
						</li>
						<li class="col">
							...
							<ul class="sub-list">
								<li>
									<a href="http://192.168.2.80/mt/feedback/seller.php">商务合作</a>
								</li>
								<li>
									<a href="http://192.168.2.80/mt/help/link.php">友情链接</a>
								</li>
								<li>
									<a href="http://192.168.2.80/mt/biz/index.php">商户后台</a>
								</li>
								<li>
									<a href="http://192.168.2.80/mt/manage/index.php">管理美团</a>
								</li>
							</ul>
						</li>
						<li class="col">
							...
							<ul class="sub-list">
								<li>
									<a href="http://192.168.2.80/mt/about/us.php">关于美团</a>
								</li>
								<li>
									<a href="http://192.168.2.80/mt/about/job.php">工作机会</a>
								</li>
								<li>
									<a href="http://192.168.2.80/mt/about/terms.php">用户协议</a>
								</li>
								<li>
									<a href="http://192.168.2.80/mt/about/privacy.php">隐私声明</a>
								</li>
							</ul>
						</li>
						<li class="col end">
							<div class="logo-footer">
								<a href="http://192.168.2.80/mt/"><img
					...
					<div class="copyright">
						<p>
							...
							<a href="http://192.168.2.80/mt/about/terms.php">使用美团前必读</a>&nbsp;
